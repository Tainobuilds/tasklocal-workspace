    ...
    >
      <div className="w-full max-w-lg bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl my-auto">
        <header className="flex items-start justify-between gap-4 p-5 border-b border-slate-800">
          <div>
            <h2 className="font-semibold text-slate-100">Report this listing</h2>
        ...
        {!signedIn ? (
          <div className="p-8 text-center space-y-3">
            <h3 className="font-semibold text-slate-100">Sign in to file a report</h3>
            ...
            <Link
              ...
              className="inline-block bg-indigo-600 hover:bg-indigo-500 text-white px-5 py-2 rounded-lg text-sm font-medium"
            >
              Sign in
            </Link>
          </div>
          ...
          <div className="p-8 text-center space-y-3">
            ...
            <h3 className="font-semibold text-slate-100">Report submitted</h3>
            <p className="text-sm text-slate-400">
              Our trust &amp; safety team will review it. Reference{' '}
              <span className="font-mono text-slate-300">{result.reportId}</span>.
            </p>
            {result.possibleDuplicate && (
              <p className="text-xs text-amber-300 bg-amber-950/40 border border-amber-800/60 rounded-lg p-3 text-left">
            ...
            <button
              type="button"
              onClick={onClose}
              className="mt-1 bg-indigo-600 hover:bg-indigo-500 text-white px-5 py-2 rounded-lg text-sm font-medium"
            >
              Done
            </button>
          </div>
          ...
          <form onSubmit={submit} className="p-5 space-y-4">
            <fieldset>
              <legend className="text-sm text-slate-300 font-medium mb-2">
            ...
            <label className="block">
              <span className="text-sm text-slate-300 font-medium">What happened?</span>
              <textarea
                value={details}
                ...
                className="mt-1.5 w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-slate-100 focus:outline-none focus:border-indigo-500 resize-y"
              />
            </label>

            {error && (
              <p className="flex items-start gap-2 text-sm text-rose-300 bg-rose-950/50 border border-rose-800/60 rounded-lg p-3">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 bg-rose-700 hover:bg-rose-600 disabled:bg-slate-800 disabled:text-slate-500 disabled:cursor-not-allowed text-white py-2 rounded-lg text-sm font-medium transition-colors"
              >
